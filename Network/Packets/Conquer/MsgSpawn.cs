...
namespace YiX.Network.Packets.Conquer
{
    ...
    public unsafe struct MsgSpawn
    {
        ...
        public static byte[] Create(Player human)
        {
            ...
            packet->Head = human.GetEquip(MsgItemPosition.Head).ItemId;
            packet->Armor = human.GetEquip(MsgItemPosition.Armor).ItemId;
            packet->MainHand = human.GetEquip(MsgItemPosition.RightWeapon).ItemId;
            packet->OffHand = human.GetEquip(MsgItemPosition.LeftWeapon).ItemId;
