...
namespace Yi.Items
{
    public partial class Item
    {
        ...
        {
            public Item CreateMoney(int amount) => Create(IdFromAmount(amount));
            public Item Create(ItemNames name) => Create((int)name);
            internal Item Create(int id) => Collections.Items.ContainsKey(id) ? Create(Collections.Items[id]) : null;

            internal Item Create(Item original)
            {
