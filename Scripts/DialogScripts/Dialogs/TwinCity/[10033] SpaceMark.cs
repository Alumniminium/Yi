                ...
                switch (control)
                {
                    case 0:
                    {
                        if (player.IsWaterTaoist())
                        {
                            ...
                            {
                                yi
                                    .Text($"Hello {player.Name.TrimEnd('\0')}, I am here to sell you a WindSpell for 100 silver, are you interested?")
                                    .Link("Yes, I am.", 1)
                    ...
                    case 1:
                    {
                        ...
                        {
                            player.Money -= 100;
                            var windSpell = Item.Factory.Create(ItemNames.SpaceMark7);
