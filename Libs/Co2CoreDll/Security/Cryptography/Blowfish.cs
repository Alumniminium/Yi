...
namespace CO2_CORE_DLL.Security.Cryptography
{
    public unsafe class Blowfish
    {
        ...
        {
            var LeftValue = ((UInt32*)pBlock)[0];
            var RightValue = ((UInt32*)pBlock)[1];
            LeftValue ^= P[0];
        ...
        public void Encrypt(Byte* pBuf, Int32 Length)
        {
            ...
            while (Length-- > 0)
            {
                ...
                var val = (Byte)(*pBuf ^ pBlock[EncryptNum ^ 3]);
        ...
        public void Decrypt(Byte* pBuf, Int32 Length)
        {
            ...
            while (Length-- > 0)
            {
                ...
                var val = (Byte)(*pBuf ^ pBlock[DecryptNum ^ 3]);
                var tmp = *pBuf;
        ...
        public void GenerateKey(String BufKey)
        {
            ...
            var Length = Kernel.strlen(BufKey.ToPointer(pBufKey));
